var WebEntityContextMenu = Class.create(ContextMenu,{
        ...
        switch(get_elem_id(elem).replace("_text",""))
        {
            case "add":
                ...
                new Ajax.Request("index.php",
                {
                    ...
                    onSuccess: function(transport) {
                        ...
                        getWindowManager().show_window("Window_Window"+new_item.replace(/_/g,''),new_item,params,obj.opener_object,obj.opener_item.getAttribute("target_object"));
                    }
                });
                break;
            ...
            case "up":
                ...
                if (sible!=null) {
                    ...
                    new Ajax.Request("index.php", {
                        method:"post",
                        parameters: {object_id: current_target,hook: "move", arguments: Object.toJSON(args)},
                        onSuccess: function(transport)
                        {                            
