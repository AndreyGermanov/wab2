var MetadataObjectTag = Class.create(Entity, {
        ...
        new Ajax.Request("index.php", {
            ...
            onSuccess: function(transport) {
                ...
                if (response!="") {
                	...
                	if (obj.old_name!="" && (obj.old_name!=data["name"])) {
	                	...
	                	for (i=0;i<elems.length;i++) {
	                		...
	                		if (elem.id!=null) {
	                			...
	                			if (elem_end==obj.old_name) {
	                                ...
	                                params["old_title"] = obj.old_name;
	                                params["parent"] = new_owner_id;
	                                params["sorting"] = "none";
	                                var icon = obj.skinPath+"images/Tree/tag.png";
	                                params["image"] = icon;
	                                if (data["old_name"]=="") {
	                                    params["action"] = "add";
                	...
                	if (obj.old_name=="") {
                        ...
                        var new_owner_id = old_owner_id;
                        var old_id = "MetadataObjectTag_"+obj.module_id+"_"+obj.rnd+"_"+data["name"];
                        var new_id = old_id;
                        var new_target_id = new_id;
                        var params = new Array;
                        if (obj.opener_item.parentNode !=null)
                        ...
                        params["old_title"] = data["name"];
                        params["parent"] = new_owner_id;
                        params["sorting"] = "keyAlpha";
                        icon = obj.skinPath+"images/Tree/tag.png";
                        params["image"] = icon;
                        params["action"] = "add";
                        obj.raiseEvent("NODE_CHANGED",params,true);                		
                	}
