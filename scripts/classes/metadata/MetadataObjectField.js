var MetadataObjectField = Class.create(Entity, {
    ...
    OK_onClick: function(event) {
        ...
        args["params"] = this.fieldParamsTable.getSingleValue();
            ...
            onSuccess: function(transport) {
                ...
                if (response!="") {
	                	...
	                	for (i=0;i<elems.length;i++) {
	                		...
	                		if (elem.id!=null) {
	                			...
	                			if (elem_end==obj.old_name) {
	                                ...
	                                params["sorting"] = "none";
	                                var icon = obj.skinPath+"images/Tree/field.png";
	                                params["image"] = icon;
	                                if (data["old_name"]=="") {
	                                    params["action"] = "add";
                	...
                	if (obj.old_name=="") {
                        ...
                        var new_owner_id = old_owner_id;
                        var old_id = "MetadataObjectField_"+obj.module_id+"_"+obj.rnd+"_"+data["name"];
                        var new_id = old_id;
                        var new_target_id = new_id;
                        var params = new Array;
                        if (obj.opener_item.parentNode !=null)
