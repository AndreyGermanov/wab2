<?php
// Справочник типов документов удостоверения личности
class ReferenceIdDocumentTypes extends Reference {
	
	function construct($params) {
		parent::construct($params);
		$this->clientClass = "ReferenceIdDocumentTypes";
		$this->hierarchy = true;
		$this->parentClientClasses = "Reference~Entity";
		$this->classListTitle = "Документы удостоверения личности";
		$this->classTitle = "Документ удостоверения личности";		
        ...
        $this->tabset_id = "WebItemTabset_".$this->module_id."_ReferenceIdDocumentTypes".$this->name;
	...
	function renderForm() {
		$blocks = getPrintBlocks(file_get_contents("templates/docflow/common/ReferenceIdDocumentTypes.html"));
