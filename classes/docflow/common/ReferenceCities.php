<?php
// Справочник городов
class ReferenceCities extends Reference {
	
	function construct($params) {
		parent::construct($params);
		$this->clientClass = "ReferenceCities";
		$this->hierarchy = true;
		$this->parentClientClasses = "Reference~Entity";
		$this->classListTitle = "Города";
		$this->classTitle = "Города";		
        ...
        $this->tabset_id = "WebItemTabset_".$this->module_id."_ReferenceCities".$this->name;
