...
class ReferenceProductKinds extends Reference {
	
	function construct($params) {
		parent::construct($params);
		$this->clientClass = "ReferenceProductKinds";
		$this->hierarchy = true;
		$this->parentClientClasses = "Reference~Entity";
		$this->classListTitle = "Виды номенклатуры";
		$this->classTitle = "Вид номенклатуры";		
        ...
        $this->tabset_id = "WebItemTabset_".$this->module_id."_ReferenceProductKinds".$this->name;
