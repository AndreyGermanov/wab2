...
class ReferenceAppointments extends Reference {
	
	function construct($params) {
		parent::construct($params);
		$this->clientClass = "ReferenceAppointments";
		$this->hierarchy = true;
		$this->parentClientClasses = "Reference~Entity";
		$this->classListTitle = "Должности";
		$this->classTitle = "Должность";		
        ...
        $this->tabset_id = "WebItemTabset_".$this->module_id."_ReferenceAppointments".$this->name;
